...
namespace App2
{
    class Program
    {
        ...
        {
            Console.Title = "APP2";
            HeartbeatReceive hbr = new HeartbeatReceive(9050);
            HeartbeatSend hbs = new HeartbeatSend(9051);
            hbs.message = "Microsoft : Datenbank";
            int eingabe;
            ...
            do
            {
                ...
                switch (eingabe)
                {
                    ...
                    case 2:
                        ...
                        break;
                    case 3:
                        if ((hbr.lastrecieve - DateTime.Now).TotalSeconds > 3)
                        {
